...
def test_two_body_accelerations_are_equal_and_opposite_in_force():
    ...
    engine.add_entity(GravEntity(id=1, mass=2.0, pos=(0.0, 0.0, 0.0)))
    engine.add_entity(GravEntity(id=2, mass=3.0, pos=(1.0, 0.0, 0.0)))
...
def test_total_momentum_is_initially_zero():
    ...
    engine.add_entity(GravEntity(id=1, mass=1.0, vel=(1.0, 0.0, 0.0)))
    engine.add_entity(GravEntity(id=2, mass=1.0, vel=(-1.0, 0.0, 0.0)))
